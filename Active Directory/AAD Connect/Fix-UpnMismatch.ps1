...
$Users = foreach ($OU in $OUs) {
    Get-ADUser -Filter * -Properties DisplayName, EmailAddress, UserPrincipalName, Enabled, DistinguishedName -ResultSetSize $null -SearchBase $OU -SearchScope OneLevel
}
$Users.Count
